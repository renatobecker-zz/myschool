...
class AdminDisciplinasController extends AdminController {
    ...
    public function getIndex()
    {
        ...
        $titulo = 'Aulas'; 
        $aulas = Aula::where('professor_id', $id)->orderBy('created_at', 'DESC')->get();
    ...
    */
    ...
    public function postEditar()
    {
        ...
        //Erro de validação de formulário
        return Redirect::to('admin/disciplinas/editar/' . $disciplina->slug)->withInput()->withErrors($validator);
    }
