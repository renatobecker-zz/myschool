...
{{ Form::open(array('url' => 'admin/disciplinas/inserir', 'class' => 'form-horizontal', 'role' => 'form')) }}
...
<div class="form-group {{{ $errors->has('descricao') ? 'error' : '' }}}">  
    ...
    <div class="col-lg-6">
        {{ Form::textarea('descricao', '', array('class' => 'form-control', 'placeholder' => 'Descrição')) }}
        {{ $errors->first('descricao', '<span class="help-block">:message</span>') }}       
    </div>
</div>
 
<div class="form-group {{{ $errors->has('dia_semana') ? 'error' : '' }}}">  
    <label for="dia" class="col-lg-2 control-label">Dia da Semana</label>
    <div class="col-lg-6">
        {{ Form::select('dia_semana', $days , Input::old('dia_semana'), array('id' => 'dia_semana')) }}
...
<div class="form-group {{{ $errors->has('inicio_semestre') ? 'error' : '' }}}">  
    ...
    <div class="col-lg-6">
        <div class="input-group bootstrap-timepicker">
            {{ Form::text('inicio_semestre', Input::old('inicio_semestre'), array('class'=> 'form-control datepicker input-small', 'data-format' => 'dd/MM/yyyy')) }}
...
<div class="form-group {{{ $errors->has('fim_semestre') ? 'error' : '' }}}">  
    ...
    <div class="col-lg-6">
        <div class="input-group bootstrap-timepicker">
            {{ Form::text('fim_semestre', Input::old('fim_semestre'), array('class'=> 'form-control datepicker input-small')) }}
            <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
        </div>    
...
<div class="form-group {{{ $errors->has('check_in_inicio') ? 'error' : '' }}}">  
    ...
    <div class="col-lg-6">
        <div class="input-group bootstrap-timepicker">
            {{ Form::text('check_in_inicio', '', array('class'=> 'form-control timepicker input-small')) }}
...
<div class="form-group {{{ $errors->has('check_in_final') ? 'error' : '' }}}">  
    ...
    <div class="col-lg-6">
        <div class="input-group bootstrap-timepicker">
            {{ Form::text('check_in_final', '', array('class'=> 'form-control timepicker input-small')) }}
            <span class="input-group-addon"><i class="glyphicon glyphicon-time"></i></span>
        </div>    
